    ...
    const fetchUsers = async () => {
      ...
      try {
        const url = selectedTier
          ? `${API_BASE_URL}?tier=${selectedTier}`
          : API_BASE_URL;
      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ mb: 5 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
            Enterprise cluster analytics loop linked to Python Isolation Forest
        ...
        >
          ...
          >
            <CardContent sx={{ p: 2.5, "&:last-child": { pb: 2.5 } }}>
              ...
              <Typography
                variant="h4"
                sx={{ fontWeight: 700, mt: 0.5, color: "success.dark" }}
              >
                {tier1Count}
              </Typography>
            </CardContent>
          ...
          >
            <CardContent sx={{ p: 2.5, "&:last-child": { pb: 2.5 } }}>
              ...
              <Typography
                variant="h4"
                sx={{ fontWeight: 700, mt: 0.5, color: "primary.dark" }}
              >
                {tier2Count}
              </Typography>
            </CardContent>
          ...
          >
            <CardContent sx={{ p: 2.5, "&:last-child": { pb: 2.5 } }}>
              ...
              <Typography
                variant="h4"
                sx={{ fontWeight: 700, mt: 0.5, color: "warning.dark" }}
              >
                {tier3Count}
              </Typography>
            </CardContent>
        ...
        >
          ...
          >
            <FormControl size="small" sx={{ minWidth: 280 }}>
              <InputLabel id="tier-select-label">
                Target Market Cohort
              </InputLabel>
              <Select
              ...
              >
                <MenuItem value="">
                  <em>Show All Target Domains</em>
                </MenuItem>
                <MenuItem value="Tier 1">
                  Tier 1 (High Value Portfolio Users)
                </MenuItem>
                <MenuItem value="Tier 2">
                  Tier 2 (Standard Core Frequency Users)
                </MenuItem>
                <MenuItem value="Tier 3">
                  Tier 3 (Dormant Pipeline / At-Risk Users)
                </MenuItem>
              </Select>
            </FormControl>
                    ...
                    users.map((user) => (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <Chip
                            size="small"
                            {...getChipProps(user.customerTier)}
